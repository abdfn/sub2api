...
// fakeCodexTicketState 为打票回归测试提供 fake Codex Ticket State 辅助实现
...
// ticketTestAccount 为打票回归测试提供 ticket Test Account 辅助实现
...
// ticketTestService 为打票回归测试提供 ticket Test Service 辅助实现
...
// TestOpenAICodexTicketTargetLengthByPlan 验证 Open AICodex Ticket Target Length By Plan 场景
...
// TestOpenAICodexTicket_Team332Personal292AndWrongLengthIsolation 验证 Open AICodex Ticket Team332 Personal292 And Wrong Length Isolation 场景
...
// TestOpenAICodexTicketStatusesUsePerAccountTargetLength 验证 Open AICodex Ticket Statuses Use Per Account Target Length 场景
...
// TestApplyOpenAICodexTicket_ReplacesHeader 验证 Apply Open AICodex Ticket Replaces Header 场景
...
// TestApplyOpenAICodexTicket_DoesNotReuseOtherModelOrAccount 验证 Apply Open AICodex Ticket Does Not Reuse Other Model Or Account 场景
...
// TestLookupOpenAICodexTicket_PrefersNewerExtra 验证 Lookup Open AICodex Ticket Prefers Newer Extra 场景
...
// TestApplyOpenAICodexTicket_ExpiredNotInjected 验证 Apply Open AICodex Ticket Expired Not Injected 场景
...
// TestApplyOpenAICodexTicket_WrongLengthNotInjected 验证 Apply Open AICodex Ticket Wrong Length Not Injected 场景
...
// TestApplyOpenAICodexTicket_FailOpenSkipsInject 验证 Apply Open AICodex Ticket Fail Open Skips Inject 场景
...
// TestApplyOpenAICodexTicket_DisabledNoop 验证 Apply Open AICodex Ticket Disabled Noop 场景
...
// TestHarvestOpenAICodexTicket_StopsAt292AndUsesHarvestProxy 验证 Harvest Open AICodex Ticket Stops At292 And Uses Harvest Proxy 场景
...
// TestHarvestOpenAICodexTicket_TeamAccepts332 验证 Harvest Open AICodex Ticket Team Accepts332 场景
...
// TestHarvestOpenAICodexTicket_HTTP503DoesNotAbortHunt 验证 Harvest Open AICodex Ticket HTTP503 Does Not Abort Hunt 场景
...
// TestLookupOpenAICodexTicket_HydratesFromExtra 验证 Lookup Open AICodex Ticket Hydrates From Extra 场景
...
// TestOpenAICodexTicketStatuses_ReportsRemainingTTL 验证 Open AICodex Ticket Statuses Reports Remaining TTL 场景
...
// TestExtractOpenAICodexTicketModel 验证 Extract Open AICodex Ticket Model 场景
...
// ListByPlatform 为打票回归测试提供 List By Platform 辅助实现
func (r *codexTicketRefreshRepo) ListByPlatform(context.Context, string) ([]Account, error) {
	return r.accounts, nil
}

// UpdateExtra 为打票回归测试提供 Update Extra 辅助实现
...
// TestRefreshOpenAICodexTickets_ConcurrentModelsPreserveAccountSnapshot 验证 Refresh Open AICodex Tickets Concurrent Models Preserve Account Snapshot 场景
...
// TestOpenAICodexTicketStatuses_RespectRuntimeConfiguration 验证 Open AICodex Ticket Statuses Respect Runtime Configuration 场景
...
// TestProbeOpenAICodexTicket_RejectsInvalidState 验证 Probe Open AICodex Ticket Rejects Invalid State 场景
...
// TestOpenAICodexTicket_RequiresActualLengthAndExpiry 验证 Open AICodex Ticket Requires Actual Length And Expiry 场景
