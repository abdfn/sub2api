...
type OpenAIGatewayService struct {
	...
	// openaiCodexTickets: accountID\x00model → *openAICodexTicket，个人 292 / Team 332 门票。
	openaiCodexTickets             sync.Map
	openaiCodexTicketQuotaPauses   sync.Map // account ID -> *openAICodexTicketHarvestPause
	openaiCodexTicketInvalidTokens sync.Map // account ID -> *openAICodexTicketTokenInvalidation
	...
	openaiCodexTicketStatusMu      sync.RWMutex
	openaiCodexTicketProgress      map[string]openAICodexTicketProgress
	openaiCodexTicketNextHarvest   time.Time
	openaiCodexTicketLogs          openAICodexTicketLogStore
	openaiCodexTicketCountries     openAICodexTicketCountryResolver
}
