export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicket: 'Codex ticket (Personal 292 / Team 332)',
        codexTurnTicketDesc: 'Ticket status for the configured models. Personal accounts use 292-byte tickets and Team accounts use 332-byte tickets. Requests are paused without a valid ticket only when fail-closed is enabled.',
        codexTurnTicketMissing: 'No valid ticket; requests remain allowed',
        codexTurnTicketReady: '{time} left',
        codexTurnTicketPaused: 'No matching Codex ticket; this model is paused',
        codexTurnTicketRateLimited: 'Rate limited; waiting for recovery',
        codexTurnTicketAttempts: '{count} ticket attempts',
        codexTurnTicketAttemptsHint: 'Actual attempts in the current round; retained after success and reset when the next round starts.',
        codexTurnTicketHarvesting: 'Getting ticket',
        codexTurnTicketHarvestPaused: 'Quota exhausted; ticket harvesting stopped',
        codexTurnTicketTokenInvalid: 'Token invalid; ticket harvesting stopped',
        codexTurnTicketNextHarvest: 'Next attempt in {time}',
        codexTurnTicketWaiting: 'Waiting for next attempt',
        codexTicketLogs: {
          title: 'Live Codex ticket logs',
          view: 'View ticket logs for {model}',
          viewAttempts: 'View ticket logs for {model} ({count} attempts)',
          live: 'Updates every 2 seconds',
          retrying: 'Refresh failed; retrying automatically',
          ready: 'Valid ticket acquired',
          disabled: 'Automatic ticket harvesting is disabled',
          nextAttempt: 'Next attempt: {time}',
          loadFailed: 'Failed to load logs. Please retry.',
          refreshFailed: 'Refresh failed. Previous logs are retained; retrying automatically.',
          retry: 'Retry',
          empty: 'No ticket logs yet. New ticket requests will appear here automatically.',
          ...
          egressUnavailableHint: 'This older log or the current ticket connection has no confirmed egress IP.',
          egressFailed: 'Failed',
          egressProbing: 'Probing',
          egressViewFailure: 'View failure details',
          egressNotAttemptedHint: 'No egress IP probe was started for this record.',
          egressFailureTitle: 'Egress IP probe failed',
          egressRecordTime: 'Recorded at',
          egressProbeStatus: 'Probe endpoint HTTP status',
          egressMissingDiagnostic: 'This record did not save a specific reason for the egress IP probe failure.',
          egressReasons: {
            timeout: 'The egress IP probe timed out and stopped waiting (probes wait up to 10 seconds).',
            canceled: 'The egress IP probe was canceled with this request.',
            network_error: 'The probe connection failed. Check the proxy or network.',
            http_error: 'The egress IP probe endpoint returned an unexpected HTTP status.',
            connection_closed: 'The probe connection closed. Ticket retrieval requires a new connection, so this IP was not recorded as the ticket egress.',
            unsupported_protocol: 'The probe response protocol did not meet the connection verification requirements, so no egress IP was recorded.',
            response_too_large: 'The probe response exceeded the size limit, so reading stopped.',
            response_read_error: 'Reading the egress IP probe response failed.',
            missing_ip: 'The probe response did not contain an egress IP.',
            invalid_ip: 'The probe returned an invalid IP address or format.',
            ambiguous_ip: 'The probe returned multiple IP addresses, so the ticket egress was not confirmed.',
            connection_changed: 'The connection changed between probing and ticket retrieval, so the probe result was discarded.',
            ticket_connection_unavailable: 'The ticket request did not provide connection information for verification.',
            insufficient_time: 'The request had 20 seconds or less remaining, so the egress IP probe was skipped.',
            unsupported_transport: 'The current transport does not support confirming the egress IP of the ticket connection.',
            request_error: 'Creating or sending the egress IP probe request failed.',
            unknown: 'The egress IP probe failed; no further reason is available.',
          },
          egressCountryHint: 'Country information for the egress IP is provided by Country.is.',
          egressCountryPendingHint: 'The egress IP is confirmed; country information is not available yet.',
          length: 'Length (actual / target)',
          duration: 'Duration',
          updated: 'Last updated: {time}',
          retention: 'Only the latest {count} events are retained. Recording starts when logging is enabled; logs are cleared on server restart.',
          retentionPending: 'Recording starts when logging is enabled. Only recent events are retained; logs are cleared on server restart.',
          events: {
            started: 'Started',
          ...
          reasons: {
            ...
            harvested: 'Acquired a ticket with the required length',
            http_error: 'Upstream returned an error; see the HTTP status',
            quota_exhausted: 'Ticket request returned 429 and 5h or 7d usage reached 100%; ticket harvesting stopped, model requests remain allowed',
            missing_state: 'Upstream response did not contain a ticket',
            length_mismatch: 'Ticket length does not match the target for this account',
            invalid_state: 'Upstream returned an invalid ticket format',
            token_error: 'Failed to read or refresh account credentials',
            token_invalid: 'Token invalid; ticket harvesting stopped',
            timeout: 'Ticket request timed out',
            canceled: 'Ticket request was canceled',
            network_error: 'Failed to connect to upstream; check the proxy or network',
            request_error: 'Failed to create or execute the ticket request',
            unknown: 'Ticket attempt did not complete; no further details are available',
          },
        },
