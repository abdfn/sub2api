export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicket: 'Codex 门票（个人 292 / Team 332）',
        codexTurnTicketDesc: '显示已配置模型的门票状态。个人账号使用 292 长度门票，Team 账号使用 332；仅在启用缺票拦截时，没有有效门票的模型才会暂停调度。',
        codexTurnTicketMissing: '暂无有效门票，仍允许请求',
        codexTurnTicketReady: '剩余 {time}',
        codexTurnTicketPaused: '未打到对应 Codex 门票，该模型已暂停',
        codexTurnTicketRateLimited: '限流中，等待恢复',
        codexTurnTicketAttempts: '打票 {count} 次',
        codexTurnTicketAttemptsHint: '当前轮次的实际打票次数；成功后保留，下一轮开始时重新计数。',
        codexTurnTicketHarvesting: '打票中',
        codexTurnTicketHarvestPaused: '额度已满，已停止打票',
        codexTurnTicketTokenInvalid: '令牌失效，已停止打票',
        codexTurnTicketNextHarvest: '下次打票 {time}',
        codexTurnTicketWaiting: '等待打票',
        codexTicketLogs: {
          title: 'Codex 实时打票日志',
          view: '查看 {model} 的打票日志',
          viewAttempts: '查看 {model} 的打票日志（打票 {count} 次）',
          live: '每 2 秒自动刷新',
          retrying: '刷新异常，正在自动重试',
          ready: '已获得有效门票',
          disabled: '自动打票未启用',
          nextAttempt: '下次打票：{time}',
          loadFailed: '日志加载失败，请重试。',
          refreshFailed: '刷新失败，已保留上次日志，稍后自动重试。',
          retry: '重试',
          empty: '暂无打票日志。新的打票请求发起后，记录会自动显示在这里。',
          time: '时间（最新在前）',
          attempt: '轮内次数',
          result: '结果',
          reason: '原因',
          egressIp: '出口 IP',
          egressCountry: '出口国家',
          egressUnavailable: '未获取',
          egressUnavailableHint: '旧日志或当前打票连接尚未确认出口 IP。',
          egressFailed: '失败',
          egressProbing: '探测中',
          egressViewFailure: '查看失败详情',
          egressNotAttemptedHint: '该记录未发起出口 IP 探测。',
          egressFailureTitle: '出口 IP 探测失败',
          egressRecordTime: '记录时间',
          egressProbeStatus: '探测接口 HTTP 状态',
          egressMissingDiagnostic: '该记录未保存出口 IP 探测的具体原因。',
          egressReasons: {
            timeout: '出口 IP 探测超时，已停止等待（探测最多等待 10 秒）。',
            canceled: '出口 IP 探测随本次请求被取消。',
            network_error: '探测请求连接失败，请检查代理或网络。',
            http_error: '出口 IP 探测接口返回异常 HTTP 状态。',
            connection_closed: '探测连接已关闭，后续打票需要新建连接，未将该 IP 记为打票出口。',
            unsupported_protocol: '探测响应的协议不符合当前连接核对要求，未记录出口 IP。',
            response_too_large: '探测接口返回的数据超出大小限制，已停止读取。',
            response_read_error: '读取出口 IP 探测响应时出错。',
            missing_ip: '探测接口响应中没有出口 IP。',
            invalid_ip: '探测接口返回的 IP 格式或地址无效。',
            ambiguous_ip: '探测接口返回了多个 IP，未确认本次打票使用的出口。',
            connection_changed: '探测与打票使用的连接发生变化，已弃用该探测结果。',
            ticket_connection_unavailable: '本次打票没有取得可用于核对的连接信息。',
            insufficient_time: '本次请求剩余时间不超过 20 秒，已跳过出口 IP 探测。',
            unsupported_transport: '当前网络传输方式不支持确认同一打票连接的出口 IP。',
            request_error: '创建或发送出口 IP 探测请求时出错。',
            unknown: '出口 IP 探测失败，暂未提供进一步原因。',
          },
          egressCountryHint: '出口 IP 的国家信息由 Country.is 提供。',
          egressCountryPendingHint: '出口 IP 已确认，国家信息暂未获取。',
          length: '长度（实际 / 目标）',
          duration: '耗时',
          updated: '最近刷新：{time}',
          retention: '仅保留最近 {count} 条事件。日志从功能启用后开始记录，服务重启后清空。',
          retentionPending: '日志从功能启用后开始记录，仅保留最近事件，服务重启后清空。',
          events: {
            started: '开始打票',
            success: '获得门票',
            miss: '未命中',
          ...
          reasons: {
            request_started: '已发起打票请求',
            harvested: '已取得符合目标长度的门票',
            http_error: '上游返回错误，详见 HTTP 状态码',
            quota_exhausted: '打票返回 429，且 5h 或 7d 用量已达到 100%，已停止打票，仍允许模型请求',
            missing_state: '上游响应未携带门票',
            length_mismatch: '门票长度与当前账号的目标长度不符',
            invalid_state: '上游返回的门票格式无效',
            token_error: '读取或刷新账号凭据失败',
            token_invalid: '令牌失效，已停止打票',
            timeout: '打票请求超时',
            canceled: '打票请求已取消',
            network_error: '连接上游失败，请检查代理或网络',
            request_error: '创建或执行打票请求失败',
            unknown: '打票未完成，暂无进一步原因',
          },
        },
